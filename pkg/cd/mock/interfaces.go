...
func (mr *MockDriverMockRecorder) CreateOrUpdateCluster(ctx, id, cluster interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) CreateOrUpdateHelmApplication(ctx, id, app interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) DeleteCluster(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) DeleteHelmApplication(ctx, id, backgroundDelete interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
